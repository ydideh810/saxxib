  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="terminal-text text-xs">{t('settings.language.title')}</h3>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
        {supportedLanguages.map((language) => (
          <button
            ...
            `}
          >
            <span className="terminal-text text-[8px] md:text-[10px] flex-1 text-left">
              {language.name}
            </span>
      ...
      <div className="border border-[var(--theme-color)] rounded p-4">
        <p className="terminal-text text-[10px] mb-2">{t('settings.language.current')}:</p>
